...
int     main(void){
    ...
    *root = ft_create_elem((void *) 12);
    ...
    printf("\n\n");
    printf("-----To free and print free_root-----\n");
    t_list *free_root = ft_create_elem(8);
    ft_list_push_back(free_root, 9);
    ft_list_push_back(free_root, 10);
    ft_list_clear(free_root, &free);
    //ft_print_my_linked_list(&free_root);
    //print_my_linked_list(free_root);
