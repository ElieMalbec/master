...
int main(int argc, char *argv[]) {
  ...
  if (pid_fils2==0){ // dans le fils2
	...
	printf("fils 2 : valeur tube1[1] : %d \n",tube1[1]);
printf("fils 2 : valeur tube2[0] : %d \n",tube2[0]);
	printf("fils 2 : valeur tube2[1] : %d \n",tube2[1]);
    exit(1);
  }
 ...
 printf("fils 1 : valeur tube1[1] : %d \n",tube1[1]);
printf("fils 1 : valeur tube2[0] : %d \n",tube2[0]);
	printf("fils 1 : valeur tube2[1] : %d \n",tube2[1]);
