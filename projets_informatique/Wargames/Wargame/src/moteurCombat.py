...
def moteur_de_combat(armee1, armee2):
    ...
    Le moteur de combat permet de déterminer une armée gagnante, nous pasosns en paramètres les deux armées
    ...
    #     Tant qu'une armée n'est pas battue, nous continuons le combat.
    while not armee1.armee_battue() and not armee2.armee_battue():
        ...
        # Nous recalculons les totaux des armées pour le prochain tour avec les combattants restants
    ...
    # Quand une armée est battue, nous retournons une valeur correspondant à sa position dans les paramètres
